...
/**
 * There is a room with n lights which are turned on
 * initially and 4 buttons on the wall.
 ...
 * Input: n = 3, m = 1.
 * Output: 4
 * Explanation: Status can be: [off, on, off],
 * [on, off, on], [off, off, off], [off, on, on].
 *
 * Note: n and m both fit in range [0, 1000].
 */
public class Solution {
    // the key to this problem is to find out that
    // when m>=3 there will be only 8 combinations.
