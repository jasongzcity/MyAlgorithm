package contest.FallingSquare_699;

/**
 * On an infinite number line (x-axis), we drop given squares in the order they are given.
 * The i-th square dropped (positions[i] = (left, side_length))
 * is a square with the left-most point being positions[i][0] and
 ...
 * Each height ans[i] represents the current highest height of
 * any square we have dropped, after dropping squares represented by
...
public class Solution {
    // https://discuss.leetcode.com/category/1563/falling-squares
}
