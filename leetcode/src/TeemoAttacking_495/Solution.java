 ...
 * Output: 3
 * Explanation: At time point 1,
 * Teemo starts attacking Ashe and makes Ashe be poisoned.
 * This poisoned status will last 2 seconds until the end of time point 2.
 ...
 * You may assume the numbers in the Teemo's attacking
 * time series and his poisoning time duration
 * per attacking are non-negative integers, which won't exceed 10,000,000.
 */
public class Solution {
    // naive solution
    public int findPoisonedDuration(int[] timeSeries, int duration) {
        // assume timeseries sorted
